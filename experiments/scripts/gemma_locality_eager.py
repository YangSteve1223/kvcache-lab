#!/usr/bin/env python3
"""Gemma-2-9B-IT Locality Characterization - Eager Mode with output_attentions=True
...
def main():
    print("=" * 60)
    print("Gemma-2-9B-IT Eager Locality Characterization")
    print("=" * 60)
    ...
    print("Loading Gemma-2-9B-IT in EAGER mode (no SDPA)...")
    ...
    # Save results
    out_file = os.path.join(OUTPUT_DIR, "gemma_locality_eager.json")
